...
$email = $hiddenkey = "";
$email_err = $hiddenkey_err = $login_err = ""; //why do I need these variables to look like this
    ...
    if(empty($email_err) && empty($hiddenkey_err)){
        ...
        if($stmt = mysqli_prepare($conn, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                // Check if email exists, if yes then verify hiddenkey
